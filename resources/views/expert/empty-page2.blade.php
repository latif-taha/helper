...
<div id="main-wrapper">
    ...
    ***********************************-->
	...
	<script src="{{ asset('accueil/Helper/partenaire/vendor/jquery-nice-select/js/jquery.nice-select.min.js')}}"></script>	<script src="{{ asset('accueil/Helper/partenaire/js/custom.min.js')}}"></script>
