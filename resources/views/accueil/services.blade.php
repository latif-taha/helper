        ...
        <div class="container position-relative">
          <div class="row d-flex justify-content-center">
            <div class="col-lg-6 text-center">
              <h2>Services</h2>
              <p>At Helper, our mission is to provide efficient and high-quality home services while ensuring customer satisfaction. We aim to create a seamless experience for both clients and partners.
    ...
    <section id="featured-services" class="featured-services">
      ...
      <div class="col-lg-4 col-md-6 service-item d-flex" data-aos="fade-up" data-aos-delay="200">
        ...
        <div>
          ...
          <p class="description">Booking a service with Helper is simple and convenient. Our user-friendly interface allows clients to easily browse services, select their desired options, and schedule appointments with just a few clicks.
