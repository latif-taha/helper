@php
$comments = [
	['name' => 'John Doe', 'image'=>'pic1.jpg', 'comment' => 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua...'],
	['name' => 'John Doe', 'image'=>'pic2.jpg', 'comment' => 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua...'],
	['name' => 'John Doe', 'image'=>'pic3.jpg', 'comment' => 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua...'],
];
$collection = ['k','p','o']
@endphp
<!DOCTYPE html>
								...
								<ul class="contacts">
									...
									<li class="active dlab-chat-user">
										<div class="d-flex bd-highlight">
											<div class="img_cont">
												<img src="{{ asset('client/images/avatar/1.jpg')}}" class="rounded-circle user_img" alt="">
									...
									<li class="dlab-chat-user">
										<div class="d-flex bd-highlight">
											<div class="img_cont">
												<img src="{{ asset('client/images/avatar/2.jpg')}}" class="rounded-circle user_img" alt="">
									...
									<li class="dlab-chat-user">
										<div class="d-flex bd-highlight">
											<div class="img_cont">
												<img src="{{ asset('client/images/avatar/3.jpg')}}" class="rounded-circle user_img" alt="">
												<span class="online_icon"></span>
											</div>
											<div class="user_info">
									...
									<li class="dlab-chat-user">
										<div class="d-flex bd-highlight">
											<div class="img_cont">
												<img src="{{ asset('client/images/avatar/4.jpg')}}" class="rounded-circle user_img" alt="">
												<span class="online_icon offline"></span>
											</div>
											<div class="user_info">
									...
									<li class="dlab-chat-user">
										<div class="d-flex bd-highlight">
											<div class="img_cont">
												<img src="{{ asset('client/images/avatar/5.jpg')}}" class="rounded-circle user_img" alt="">
												<span class="online_icon offline"></span>
											</div>
											<div class="user_info">
							...
							<div class="card-body msg_card_body dlab-scroll" id="DLAB_W_Contacts_Body3">
								<div class="d-flex justify-content-start mb-4">
									<div class="img_cont_msg">
										<img src="{{ asset('client/images/avatar/1.jpg')}}" class="rounded-circle user_img_msg" alt="">
									</div>
								...
								<div class="d-flex justify-content-end mb-4">
									...
									<div class="img_cont_msg">
								<img src="{{ asset('client/images/avatar/2.jpg')}}" class="rounded-circle user_img_msg" alt="">
									</div>
								</div>
								<div class="d-flex justify-content-start mb-4">
									<div class="img_cont_msg">
                    ...
                    <div class="collapse navbar-collapse justify-content-between">
                        ...
                        <ul class="navbar-nav header-right">
											...
											<li>
												<div class="timeline-panel">
													<div class="media me-2">
														<img alt="image" width="50" src="{{ asset('client/images/avatar/1.jpg')}}">
													</div>
							...
							<li class="nav-item dropdown  header-profile">
								<a class="nav-link" href="javascript:void(0);" role="button" data-bs-toggle="dropdown">
									<img src="{{ asset('client/images/user.jpg')}}" width="56" alt="">
								</a>
								<div class="dropdown-menu dropdown-menu-end">
								...
								<div class="card tryal-gradient">
									<div class="card-body tryal row">
										<div class="col-xl-7 col-sm-6">
											...
											<a href="javascript:void(0);" class="btn btn-rounded fs-18 font-w500">Explore Services</a>						
										</div>
							...
							<div class="col-xl-4">
								<div class="card tryal-gradient">
									<div class="card-body tryal row">
										<div class="col-xl-7 col-sm-6">
											<h2>IT Services</h2>
											<span>Get professional IT support for software development, network setup, and more.</span>
											<a href="/services/" class="btn btn-rounded fs-18 font-w500">Explore Services</a>
										</div>
										<div class="col-xl-5 col-sm-6">
						...
						<div class="col-xl-12 col-lg-12">
							<div class="card">
								<div class="card-header border-0">
									<div>
										<h4 class="fs-20 font-w700">Recent Comments</h4>
									</div>
									<div>
								...
								<div class="card h-100">
									...
									<div class="card-body px-0">
										...
										<div class="d-flex justify-content-between recent-emails">
											<a class="d-flex" href="#">
												<div class="profile-k">
													<span class="bg-success">{{$item}}</span>    
												</div>
												<div class="ms-3">
